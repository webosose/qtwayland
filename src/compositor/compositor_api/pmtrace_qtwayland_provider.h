 ...
 *
 * The application level API to these tracepoints is in qtwaylandtracer.h
 *
 * Copyright (c) 2016 LG Electronics, Inc.
 */

#undef TRACEPOINT_PROVIDER
#define TRACEPOINT_PROVIDER qtwayland

#undef TRACEPOINT_INCLUDE_FILE
#define TRACEPOINT_INCLUDE_FILE ./pmtrace_qtwayland_provider.h
...
#if !defined(_PMTRACE_QTWAYLAND_PROVIDER_H) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define _PMTRACE_QTWAYLAND_PROVIDER_H
...
#endif /* _PMTRACE_QTWAYLAND_PROVIDER_H */
